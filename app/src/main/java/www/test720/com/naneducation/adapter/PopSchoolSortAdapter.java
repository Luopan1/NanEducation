...
public class PopSchoolSortAdapter extends BaseAdapter {

    private Context context;
    private List<School.DataBean.TypelistBean> list;
    private int position = 0;
    private boolean islodingimg = true;
    Holder hold;

    public PopSchoolSortAdapter(Context context, List<School.DataBean.TypelistBean> list) {
        this.context = context;
        this.list = list;
    }

    public PopSchoolSortAdapter(Context context, List<School.DataBean.TypelistBean> list, boolean islodingimg) {
        this.context = context;
        this.list = list;
