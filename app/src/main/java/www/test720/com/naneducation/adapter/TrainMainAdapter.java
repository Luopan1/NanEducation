...
public class TrainMainAdapter extends BaseAdapter {
    ...
    private List<TrainList.DataBean.MuenBean> list;
    private int position = 0;
    private boolean islodingimg = true;
    Holder hold;

    public TrainMainAdapter(Context context, List<TrainList.DataBean.MuenBean> list) {
        this.context = context;
        this.list = list;
    }

    public TrainMainAdapter(Context context, List<TrainList.DataBean.MuenBean> list, boolean islodingimg) {
        this.context = context;
        this.list = list;
