...
public class TrainAdapter extends BaseAdapter {
    ...
    private List<TrainBean.DataBean.TypelistBean> list;
    private int position = 0;
    private boolean islodingimg = true;
    Holder hold;

    public TrainAdapter(Context context, List<TrainBean.DataBean.TypelistBean> list) {
        this.context = context;
        this.list = list;
    }

    public TrainAdapter(Context context, List<TrainBean.DataBean.TypelistBean> list, boolean islodingimg) {
        this.context = context;
        this.list = list;
