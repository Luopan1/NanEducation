...
public class ClassifyMainAdapter extends BaseAdapter {
    ...
    private List<StudyHomeBanner> list;
    private int position = 0;
    private boolean islodingimg = true;
    Holder hold;

    public ClassifyMainAdapter(Context context, List<StudyHomeBanner> list) {
        this.context = context;
        this.list = list;
    }

    public ClassifyMainAdapter(Context context, List<StudyHomeBanner> list, boolean islodingimg) {
        this.context = context;
        this.list = list;
    ...
    public View getView(int arg0, View view, ViewGroup viewGroup) {
        ...
        hold.txt.setText(list.get(arg0).getBa_img());
