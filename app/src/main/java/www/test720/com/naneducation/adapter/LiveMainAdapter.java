...
public class LiveMainAdapter extends BaseAdapter {
    ...
    private List<LiveBroad.DataBean.TypeListBean> list;
    private int position = 0;
    private boolean islodingimg = true;
    Holder hold;

    public LiveMainAdapter(Context context, List<LiveBroad.DataBean.TypeListBean> list) {
        this.context = context;
        this.list = list;
    }

    public LiveMainAdapter(Context context, List<LiveBroad.DataBean.TypeListBean> list, boolean islodingimg) {
        this.context = context;
        this.list = list;
